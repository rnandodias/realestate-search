...
app = FastAPI(title="RealEstate Search Service", version="0.1.0")
...
def get_embedding(text: str) -> List[float]:
    ...
    # Ajuste defensivo: alguns modelos mudam dimensões; validamos
    if len(emb) != VECTOR_SIZE:
        # Qdrant permite upsert com dimension mismatch? Por segurança, retornamos 500
